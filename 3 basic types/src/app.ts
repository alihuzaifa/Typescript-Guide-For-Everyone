...
user = { age: 21 };
// TypeScript mein, aap custom object types define kar sakte hain jisme aap specific properties ke saath unki data types bhi specify kar sakte hain.
type Human = {
  name: string;
  age: number;
  isTeenager: boolean;
